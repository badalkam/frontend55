...
export default function List() {
  ...
  // const userFromLocalStorage = getUsername().then((data)=>{console.log(data)
  // usePropStore.setState({username:data})
  // })
  // let usernameFromStore =usePropStore.getState().username
